...
const UmpiresSection = () => {
  return <section id="umpires" className="py-12 md:py-20 bg-gradient-to-b from-muted/30 to-background">
      <div className="container">
        ...
        <div className="bg-white rounded-xl shadow-[var(--shadow-card)] border border-primary/20 overflow-hidden mb-8 md:mb-12">
          <div className="flex flex-col lg:flex-row">
            <div className="order-1 lg:order-2 lg:w-2/5">
              <img src={youthUmpire} alt="Youth umpire making a call during a Rockets baseball game" className="w-full object-cover h-64 md:h-80 lg:h-full" />
            </div>
            <div className="order-2 lg:order-1 lg:flex-1 p-6 md:p-8">
