            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                  The Central District Baseball League has proudly served Burlington & Plato Center, IL and the surrounding community since 1987. As a non-profit organization, we're committed to providing exceptional youth baseball programs that emphasize skill development, teamwork, sportsmanship, and the pure joy of the game.
                </p>
