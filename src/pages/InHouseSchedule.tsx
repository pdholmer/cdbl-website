      ...
      <main>
        ...
        >
          <div className="container">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">In-House League Schedule</h1>
            <p className="text-xl mb-8 max-w-2xl">View game schedules and important dates for all In-House divisions.</p>
            <Button 
              size="lg" 
              variant="hero"
        ...
        <section className="py-16 bg-muted/30">
          <div className="container">
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
              ...
              <Card>
                <CardHeader>
                  <CardTitle>Pony & Colt (Ages 13-14)</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
...
export default InHouseSchedule;