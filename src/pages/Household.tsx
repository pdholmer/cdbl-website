...
import { LogOut, MapPin, Pencil, Phone, Mail, CalendarDays } from "lucide-react";
import {
  SectionLabel,
  GroupedCard,
  ListRow,
...
const Household = () => {
  ...
  return (
    <div className="min-h-screen bg-[hsl(217_30%_97%)] pb-16">
        ...
        {isLoading ? (
          ...
          <div className="space-y-8">
            <header className="flex items-start justify-between gap-4">
              <div>
                <h1 className="font-heading text-[34px] font-bold leading-tight tracking-tight text-foreground">
                  Hi, {greetingName}
                </h1>
              ...
              <GroupedCard>
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    <h2 className="font-heading text-lg font-bold">{household?.name}</h2>
                    {household?.address_line1 ? (
                      ...
                      <EmptyStateBlock className="mt-1">
